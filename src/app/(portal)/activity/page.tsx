...
const actionIcons: Record<string, { icon: "package" | "droplet" | "users" | "check" | "alert-triangle" | "clipboard" | "clock"; color: string; bg: string }> = {
  ...
  ASSET_RETURNED: { icon: "check", color: "text-emerald-500", bg: "bg-emerald-50" },
  ...
  CONSUMABLE_STOCK_ADDED: { icon: "droplet", color: "text-emerald-500", bg: "bg-emerald-50" },
  CONSUMABLE_REQUEST_CREATED: { icon: "clipboard", color: "text-amber-500", bg: "bg-amber-50" },
  CONSUMABLE_REQUEST_APPROVED: { icon: "check", color: "text-emerald-500", bg: "bg-emerald-50" },
  ...
  CONSUMABLE_RETURNED: { icon: "check", color: "text-emerald-500", bg: "bg-emerald-50" },
