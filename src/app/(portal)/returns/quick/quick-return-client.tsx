        ...
        <div className="px-4 pb-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-[20px] border border-shark-200 dark:border-shark-700 bg-shark-50 dark:bg-shark-800 pl-10 pr-4 text-base text-shark-900 dark:text-shark-100 placeholder:text-shark-400 focus:border-action-400 focus:outline-none focus:ring-2 focus:ring-action-400/20 transition-colors"
              style={{ height: "48px" }}
            />
          </div>
        </div>
      ...
      <div className="px-4 py-4 pb-32 space-y-3 max-w-lg mx-auto">
        ...
        {totalPending === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <Link
              href="/returns"
              className="mt-6 inline-flex items-center gap-2 rounded-[20px] bg-shark-900 px-5 py-3 text-sm font-semibold text-white hover:bg-shark-800 transition-colors"
            >
              Back to Returns
            </Link>
          </div>
        ...
        {active.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className={`rounded-[20px] bg-white dark:bg-shark-900 border transition-all shadow-sm overflow-hidden ${
            ...
            >
              ...
              <div className="px-4 pb-4 grid grid-cols-2 gap-2">
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-[20px] bg-action-600 text-white font-semibold text-base hover:bg-action-700 active:scale-[0.97] transition-all disabled:opacity-60"
                ...
                <button
                  ...
                  disabled={isProcessing}
                  className="flex items-center justify-center gap-2 rounded-[20px] border-2 border-red-300 text-red-600 font-semibold text-base hover:bg-red-50 active:scale-[0.97] transition-all disabled:opacity-60"
                  style={{ minHeight: "52px" }}
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {selected.size > 0 && (
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-shark-900 border-t border-shark-100 dark:border-shark-700 shadow-lg px-4 py-4 safe-area-pb">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-[20px] bg-action-600 text-white font-bold text-lg hover:bg-action-700 active:scale-[0.98] transition-all shadow-sm"
