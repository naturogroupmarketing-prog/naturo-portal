...
export default async function DashboardPage() {
  ...
  const stats: { widgetId: string; label: string; value: number; icon: IconName; borderColor: string; iconBg: string; iconColor: string; href: string }[] = [
    ...
    { widgetId: "stat-damaged", label: "Damaged / Lost", value: recentDamageCount, icon: "alert-triangle", borderColor: "border-t-[#E8532E]", iconBg: "bg-[#E8532E]", iconColor: "text-white", href: "/alerts/damage" },
