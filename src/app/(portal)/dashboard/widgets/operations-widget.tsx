      ...
      <div className="p-4 sm:p-6">
          ...
          <div className="text-center relative group/health">
            ...
            <div className="absolute right-0 sm:right-0 top-full mt-2 w-56 sm:w-64 bg-[#1a1c21] text-white rounded-xl p-3.5 sm:p-4 shadow-2xl opacity-0 invisible group-hover/health:opacity-100 group-hover/health:visible transition-all duration-200 z-50 text-left">
              ...
              <div className="space-y-1.5 text-xs">
                ...
                {data.unresolvedDamage > 0 && (
                  <div className="flex justify-between"><span className="text-shark-400">Unresolved damage ({data.unresolvedDamage})</span><span className="text-red-400">-{Math.min(15, data.unresolvedDamage * 5)}</span></div>
                )}
        ...
        <div className="space-y-2">
          {[
            ...
            { label: "Unresolved Damage", value: data.unresolvedDamage, icon: "alert-triangle" as const, href: "/alerts/damage", danger: true },
            { label: "Lost Items", value: data.lostItems, icon: "shield" as const, href: "/alerts/lost", danger: true },
