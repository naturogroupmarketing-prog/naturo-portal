                      ...
                      {!isChecked && (
                        <div className="flex items-center gap-2 shrink-0">
                          ...
                          <label className={`cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                            hasPhoto ? "bg-shark-100 dark:bg-shark-700 text-shark-600 dark:text-shark-400 hover:bg-shark-200 dark:bg-shark-700" : "bg-blue-500 text-white hover:bg-blue-600"
