...
export async function AiBriefingWidget(props: AiBriefingWidgetProps) {
  ...
  return (
    <Card className="overflow-hidden">
      {/* Gradient top border */}
      <div className="h-0.5 w-full bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-400" />
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-[10px] font-bold tracking-widest text-indigo-500 uppercase block">
                AI Briefing
              </span>
              <span className="text-[11px] text-shark-400">{displayDate}</span>
            </div>
          </div>
          <span className="text-[10px] font-semibold bg-indigo-50 text-indigo-600 px-1.5 py-0.5 rounded-full shrink-0 mt-0.5">
            AI
          </span>
        </div>
        ...
        {/* Footer */}
        <p className="text-[10px] text-shark-400 border-t border-shark-50 dark:border-shark-800 pt-2 mt-1">
