...
function getDueStatus(dueDate: string) {
  ...
  if (daysUntil === 0) return { label: "Due Today", color: "bg-action-100 text-action-500", urgent: true };
  if (daysUntil <= 7) return { label: `Due in ${daysUntil}d`, color: "bg-action-50 text-action-500", urgent: false };
