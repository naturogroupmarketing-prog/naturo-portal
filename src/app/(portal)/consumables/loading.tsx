  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="h-10 w-40 bg-shark-100 rounded-lg animate-pulse" />
      </div>

      {/* Tab bar */}
      <div className="flex items-center gap-1 border-b border-shark-100 pb-px">
        <div className="h-9 w-28 bg-shark-100 rounded-t-lg animate-pulse" />
        <div className="h-9 w-36 bg-shark-50 rounded-t-lg animate-pulse" />
      </div>
      ...
      <Card>
        <CardContent className="py-0">
          ...
          <div className="flex items-center gap-4 py-3 border-b border-shark-100">
            <div className="h-4 w-32 bg-shark-100 rounded animate-pulse flex-1" />
          ...
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 py-4 border-b border-shark-50 last:border-0">
              <div className="h-5 w-36 bg-shark-50 rounded animate-pulse flex-1" />
              ...
              <div className="h-5 w-16 bg-shark-50 rounded animate-pulse" />
            </div>
          ))}
        </CardContent>
      </Card>
