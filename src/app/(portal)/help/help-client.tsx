...
const FAQ_SECTIONS: FAQSection[] = [
  ...
  },
  {
    ...
    icon: "package",
    faqs: [
      { q: "How do I view my inventory?", a: "Click 'Inventory' in the sidebar. You'll see all your locations grouped by state. Click any location to see its assets and consumables. Use the tabs (Assets / Consumables / Staff) to switch between views." },
      { q: "How do I create a new asset?", a: "Go to Inventory → click a location → Assets tab → click '+ New Asset'. Fill in the name, category, and details. Each asset gets a unique code and QR code automatically." },
      { q: "How do I assign an asset to a staff member?", a: "In the Assets tab, find the asset and click 'Assign'. Select the staff member from the dropdown, choose permanent or temporary assignment, and confirm. The staff member will be notified." },
      ...
      { q: "How do I add photos to assets?", a: "When creating or editing an asset, click 'Upload Photo' or 'Change Photo' in the photo section. You can also use the AI Assistant to copy photos between items: 'Copy the mop bucket photo to all mop buckets'." },
      ...
      { q: "How do I set up a new location quickly?", a: "When you open an empty location in Inventory, you'll see a 'Set Up This Location' card. Click 'Apply Standard Items' to copy all asset and consumable types from your existing locations with one click. Each asset gets a unique code." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How do I mark an order as received?", a: "When a ORDERED purchase order arrives at your location, click 'Mark Received'. This automatically adds the quantity to your consumable stock." },
      { q: "What do the PO statuses mean?", a: "PENDING = awaiting approval. APPROVED = approved, ready to order from supplier. ORDERED = order placed with supplier. RECEIVED = goods arrived and stock updated." },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: "search",
    faqs: [
      { q: "What are monthly condition checks?", a: "Condition checks are monthly photo inspections of assigned equipment. Staff take photos of their assets and select a condition (Good, Fair, Poor, Damaged). Managers can review all submissions." },
      ...
      { q: "How do I complete my monthly inspection?", a: "On your dashboard, find the 'Monthly Condition Check' section. For each item, tap 'Photo' to take a picture, select the condition, and click 'Submit'. The progress bar shows how many items are done." },
      { q: "How do I configure which items need inspection?", a: "Go to Inspections → click 'Configure'. Toggle on the categories that require monthly photos. You can also add custom photo labels (e.g., 'Front View', 'Interior').", roles: ["SUPER_ADMIN"] },
      { q: "What happens if an inspection is overdue?", a: "Staff see a red 'Inspection Overdue!' banner on their dashboard. Managers are notified via email and in-app notification. The health score for that location is reduced." },
    ],
  },
  {
    title: "Reports & Data",
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How do I manage locations?", a: "Go to Inventory. Super Admins can add states, add locations (regions), edit location names and addresses, and delete empty locations.", roles: ["SUPER_ADMIN"] },
      { q: "How do I import bulk data?", a: "Go to Import Data in the Admin section. Download the CSV template, fill in your data, and upload. The system validates each row and shows any errors before importing.", roles: ["SUPER_ADMIN"] },
      { q: "Where is the activity log?", a: "Go to Activity Log in the Admin section. It shows every action taken in the system with who did it, when, and what changed. You can search and filter by action type.", roles: ["SUPER_ADMIN"] },
    ],
  },
  {
