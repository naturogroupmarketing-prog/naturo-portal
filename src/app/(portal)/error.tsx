      ...
      <div className="text-center max-w-md">
        ...
        <div className="flex gap-3 justify-center mt-5">
          ...
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold text-shark-700 bg-shark-100 dark:bg-shark-800 rounded-xl hover:bg-shark-200 dark:hover:bg-shark-700 dark:bg-shark-700 transition-colors"
          >
            Go to Dashboard
          </button>
        </div>
