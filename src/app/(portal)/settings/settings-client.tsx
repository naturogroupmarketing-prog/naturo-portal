...
export function SettingsClient({ userName, userEmail, userPhone, emailNotifications, hasPassword, mfaEnabled }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        <h1 className="text-[28px] sm:text-[32px] font-bold text-shark-900 dark:text-shark-100 leading-tight tracking-tight">Settings</h1>
          ...
          {mfaStep === "qr" && (
            <>
              <div className="text-center">
                ...
                <div className="bg-white dark:bg-shark-900 p-4 rounded-[20px] inline-block border border-shark-200 dark:border-shark-700 mx-auto">
                  <img
