...
export function BillingClient({ org }: Props) {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-[28px] sm:text-[32px] font-bold text-shark-900 dark:text-shark-100 leading-tight tracking-tight">Billing & Plans</h1>
                    ...
                    className={`w-full mt-5 py-2.5 rounded-[20px] text-sm font-semibold transition-colors ${
                      isCurrent
                        ...
                        : isUpgrade
                          ...
                          : isDowngrade
                            ? "border-2 border-shark-200 dark:border-shark-700 text-shark-500 dark:text-shark-400 hover:border-shark-300 dark:hover:border-shark-600"
