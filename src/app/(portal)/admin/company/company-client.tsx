            ...
            <div>
              ...
              {logoUrl ? (
                ...
                <div className="flex items-center gap-4">
                  <div className="w-24 h-24 rounded-[20px] border border-shark-200 dark:border-shark-700 bg-shark-50 dark:bg-shark-800 flex items-center justify-center overflow-hidden">
                ...
                <div
                  ...
                  className={`
                    ...
                    rounded-[20px] border-2 border-dashed px-6 py-8 transition-colors
                    ${dragOver
