          ...
          {[...byRegion.values()].map((group) => {
            ...
            return (
              <Card key={group.regionId} className="overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-[20px] bg-red-100 flex items-center justify-center">
                      ...
                      <div key={report.id} className="px-5 py-4 hover:bg-shark-50 dark:hover:bg-shark-800/30">
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex items-start gap-3 flex-1">
                            <div className="w-10 h-10 rounded-[20px] overflow-hidden bg-shark-100 dark:bg-shark-700 flex items-center justify-center shrink-0 mt-0.5">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2">
                                <span className={`text-xs font-semibold px-2 py-0.5 rounded ${report.type === "DAMAGE" ? "bg-action-100 text-action-500" : "bg-red-100 text-red-700"}`}>
                                  {report.type}
                                </span>
      ...
      <Modal open={!!resolvingReport} onClose={() => setResolvingReport(null)} title={`Resolve: ${resolvingReport?.asset.name || ""}`}>
        {resolvingReport && (
          <div className="space-y-4">
            <div className="bg-shark-50 dark:bg-shark-800 rounded-[20px] p-3">
