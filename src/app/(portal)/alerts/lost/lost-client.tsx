          ...
          {[...byRegion.values()].map((group) => {
            ...
            return (
              <Card key={group.regionId} className="overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-[20px] bg-shark-700 flex items-center justify-center">
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex items-start gap-3 flex-1">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              {item.isHighValue && <span className="text-xs text-action-500 font-medium">High Value</span>}
                            </div>
