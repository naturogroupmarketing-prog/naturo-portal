...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        ref={contentRef}
        className="w-full max-w-sm rounded-[32px] backdrop-blur-2xl bg-white/72 dark:bg-shark-800/80 border border-white/68 dark:border-white/[0.08] shadow-[0_2px_40px_rgba(80,130,220,0.16),0_1px_0_rgba(255,255,255,0.95)] dark:shadow-[0_2px_4px_rgba(0,0,0,0.20),0_12px_40px_rgba(0,0,0,0.40),inset_0_1px_0_rgba(255,255,255,0.06)] transition-all duration-200 animate-fade-in"
      >
        <div className="px-6 pt-6 pb-4 text-center">
          <div
            className={cn(
              "mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-lg",
              iconBg
            )}
          >
