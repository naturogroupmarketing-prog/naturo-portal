...
export function SetupBanner({ industry }: SetupBannerProps) {
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-3.5 rounded-[20px] bg-gradient-to-r from-action-500 to-action-600 text-white shadow-sm shadow-action-500/20 mb-6">
