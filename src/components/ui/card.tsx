    ...
    <div
      className={cn(
        ...
        "rounded-[28px] transition-colors",
        {
          ...
          "backdrop-blur-xl bg-white/62 dark:bg-shark-900/80 border border-white/70 dark:border-white/[0.08] shadow-[0_2px_32px_rgba(100,140,220,0.22),0_1px_0_rgba(255,255,255,0.95)] dark:shadow-[0_2px_4px_rgba(0,0,0,0.20),0_8px_28px_rgba(0,0,0,0.30),inset_0_1px_0_rgba(255,255,255,0.06)]": variant === "elevated",
