...
function ToastItem({ toast, onRemove }: { toast: Toast; onRemove: () => void }) {
  return (
    <div
      className={`flex items-center gap-3 pl-3.5 pr-4 py-3 rounded-[16px] bg-white dark:bg-shark-800 border border-l-[3px] border-shark-100 dark:border-white/[0.08] shadow-[0_8px_24px_rgba(0,0,0,0.14)] ${ACCENT_COLORS[toast.type]} animate-slide-in`}
      role="alert"
    >
      {ICONS[toast.type]}
