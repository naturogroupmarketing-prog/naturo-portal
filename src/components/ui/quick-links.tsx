              ...
              <div className="p-2">
                {LINKS.map((item) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-[20px] hover:bg-shark-50 dark:hover:bg-shark-800 dark:bg-transparent dark:hover:bg-shark-800/40 transition-colors text-left group"
                  >
                    <Icon
                      name={item.icon}
                      size={16}
