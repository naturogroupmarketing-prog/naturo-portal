...
export function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center pt-[12vh]">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-xl bg-white dark:bg-shark-800 rounded-[24px] border border-shark-100 dark:border-white/[0.08] shadow-[0_16px_48px_rgba(0,0,0,0.18)] dark:shadow-[0_16px_48px_rgba(0,0,0,0.45)] overflow-hidden animate-fade-in">
        {/* Search input */}
        <div className="flex items-center gap-3 px-4 py-3.5 border-b border-shark-100 dark:border-white/[0.08]">
          {searchLoading ? (
            ...
            <div className="p-2 border-b border-shark-100 dark:border-white/[0.08]">
              ...
              {searchResults && searchResults.assets.map((asset) => (
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 rounded-[10px] hover:bg-shark-50 dark:hover:bg-white/[0.06] transition-colors text-left group"
                >
                  {/* Icon */}
                  <div className="w-7 h-7 rounded-lg bg-shark-50 border border-shark-100 flex items-center justify-center shrink-0">
              ...
              {searchResults && searchResults.users.map((u) => (
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 rounded-[10px] hover:bg-shark-50 dark:hover:bg-white/[0.06] transition-colors text-left group"
                >
                  <div className="w-7 h-7 rounded-full bg-shark-50 border border-shark-100 flex items-center justify-center shrink-0">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-[10px] text-sm transition-colors ${
                          selectedIndex === idx
                            ...
                            : "text-shark-700 dark:text-shark-300 hover:bg-shark-50 dark:hover:bg-white/[0.06]"
                        }`}
                      >
                        <Icon
                          name={item.icon}
        ...
        {/* Footer */}
        <div className="border-t border-shark-100 dark:border-white/[0.08] px-4 py-2 flex items-center gap-4 text-[10px] text-shark-400">
          <span className="flex items-center gap-1">
            <kbd className="bg-shark-50 dark:bg-white/[0.07] border border-shark-100 dark:border-white/[0.10] px-1 rounded-md">&uarr;</kbd>
            <kbd className="bg-shark-50 dark:bg-white/[0.07] border border-shark-100 dark:border-white/[0.10] px-1 rounded-md">&darr;</kbd> Navigate
          </span>
          <span className="flex items-center gap-1">
            <kbd className="bg-shark-50 dark:bg-white/[0.07] border border-shark-100 dark:border-white/[0.10] px-1 rounded-md">Enter</kbd> Open
          </span>
          <span className="flex items-center gap-1">
            <kbd className="bg-shark-50 dark:bg-white/[0.07] border border-shark-100 dark:border-white/[0.10] px-1 rounded-md">Esc</kbd> Close
          </span>
          {isSearching && (
