...
export function SessionTimeoutWarning() {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 max-w-sm w-full mx-4 animate-fade-in">
      <div className="bg-action-50 dark:bg-action-900/30 border border-action-200 dark:border-action-800 rounded-[20px] px-4 py-3 shadow-lg flex items-start gap-3">
