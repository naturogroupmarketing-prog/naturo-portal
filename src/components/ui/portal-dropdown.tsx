...
export function PortalDropdown({
  ...
  return createPortal(
    <div
      ...
      style={getStyle()}
      className={cn(
        "bg-white dark:bg-shark-800 rounded-[18px] border border-shark-100 dark:border-white/[0.09] shadow-[0_8px_32px_rgba(0,0,0,0.14)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.40)] py-1.5",
        maxHeightClass,
        className
      )}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-shark-50 dark:hover:bg-white/[0.07]",
