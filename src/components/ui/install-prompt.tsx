...
export function InstallPrompt() {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-shark-900 rounded-[20px] shadow-2xl border border-shark-100 dark:border-shark-800 overflow-hidden">

        {/* ── Installed ── */}
        {installed && (
          <div className="px-5 py-4 flex items-center gap-3">
            <div className="w-9 h-9 rounded-[20px] bg-action-100 flex items-center justify-center shrink-0">
          ...
          <div className="px-5 py-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-[20px] bg-action-600 flex items-center justify-center shrink-0">
          ...
          <div className="px-5 py-4">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-[20px] bg-action-600 flex items-center justify-center shrink-0 mt-0.5">
        ...
        {!installed && (platform === "android" || platform === "desktop") && deferredPrompt && (
          <div className="px-5 py-4 flex items-center gap-4">
            <div className="w-12 h-12 rounded-[20px] bg-action-600 flex items-center justify-center shrink-0">
