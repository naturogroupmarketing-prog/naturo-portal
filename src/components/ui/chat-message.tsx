...
export function ChatMessage({ role, content, isLoading, loadingStatus, isLast, onOptionClick }: ChatMessageProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-start">
        <div className="bg-shark-50 dark:bg-shark-800 text-shark-900 dark:text-shark-100 rounded-[20px] rounded-bl-md px-4 py-3 max-w-[85%]">
  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div className="rounded-[20px] px-4 py-2.5 max-w-[85%] text-sm leading-relaxed whitespace-pre-wrap bg-action-400 text-white rounded-br-md">
          {content}
        </div>
      </div>
    );
  ...
  return (
    <div className="flex justify-start">
      <div className="rounded-[20px] px-4 py-2.5 max-w-[85%] text-sm leading-relaxed bg-shark-50 text-shark-900 rounded-bl-md">
