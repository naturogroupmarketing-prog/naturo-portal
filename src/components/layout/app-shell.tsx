  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Main content */}
        <main id="main-content" style={role === "STAFF" ? { paddingBottom: "calc(5rem + env(safe-area-inset-bottom, 0px))" } : undefined} className={`flex-1 overflow-y-auto overflow-x-hidden px-4 py-6 sm:p-6 lg:p-12 ${role === "STAFF" ? "lg:pb-12" : (role === "SUPER_ADMIN" || role === "BRANCH_MANAGER") ? "pb-36 sm:pb-24 lg:pb-16" : "pb-16 sm:pb-6 lg:pb-12"}`}>
