...
export function AppShell({ children, role, userName, userImage, pendingPOCount = 0, pendingReturnsCount = 0, orgName, orgLogo }: AppShellProps) {
  ...
  return (
    ...
    <div
      className="flex flex-col h-dvh bg-gradient-to-b from-[#eae6f5] via-[#d4d8ec] to-[#b8c2d8] dark:bg-none dark:bg-shark-950 transition-colors"
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden lg:flex flex-shrink-0 relative">
          <div
            className={`flex flex-col backdrop-blur-2xl bg-white/48 dark:bg-shark-900/80 border-r border-white/55 dark:border-white/[0.06] shadow-[1px_0_0_rgba(255,255,255,0.55)] transition-all duration-300 overflow-hidden ${
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-40 lg:hidden">
            ...
            />
            <div
              className="fixed inset-y-0 left-0 w-[min(16rem,85vw)] backdrop-blur-2xl bg-white/52 dark:bg-shark-900/85 border-r border-white/55 dark:border-white/[0.06] z-50 shadow-[4px_0_32px_rgba(120,140,220,0.22)] dark:shadow-[4px_0_32px_rgba(0,0,0,0.40)] transition-colors"
