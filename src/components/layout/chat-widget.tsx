...
export function ChatWidget() {
  ...
  return (
    <div data-no-print>
      ...
      {/* Chat panel */}
      {isOpen && (
        <div className="fixed bottom-36 right-3 sm:bottom-24 sm:right-6 z-50 w-[calc(100vw-1.5rem)] sm:w-[26rem] h-[60vh] sm:h-[36rem] max-h-[36rem] flex flex-col rounded-[20px] border border-shark-100 dark:border-shark-700 bg-white dark:bg-shark-900 shadow-2xl overflow-hidden">
            ...
            <>
                ...
                {messages.length === 0 && (
                  <div className="py-5">
                    ...
                    <div className="text-center mb-4">
                      <div className="w-12 h-12 rounded-[20px] bg-action-50 flex items-center justify-center mx-auto mb-2.5">
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      {SUGGESTIONS.map((q) => (
                        <button
                          ...
                          className="text-left text-xs text-shark-700 dark:text-shark-300 bg-shark-50 dark:bg-shark-800 border border-shark-100 dark:border-shark-700 rounded-[20px] px-3 py-2.5 hover:bg-action-50 hover:border-action-200 hover:text-action-700 transition-colors leading-snug"
                        >
                          {q}
                        </button>
                      ))}
              ...
              <form onSubmit={handleSubmit} className="border-t border-shark-100 dark:border-shark-800 px-3 py-2.5 flex items-center gap-1.5 shrink-0">
                <input
                  ...
                  className={`flex-1 min-w-0 rounded-[20px] border bg-white dark:bg-shark-800 px-3 py-2 text-sm text-shark-900 dark:text-shark-100 placeholder:text-shark-400 focus:outline-none focus:ring-2 focus:ring-action-400 focus:border-transparent disabled:opacity-50 ${
                    isListening
                ...
                {!isLoading && (
                  <button
                    ...
                    className={`shrink-0 w-9 h-9 flex items-center justify-center rounded-[20px] transition-colors ${
                      isListening
                ...
                {isLoading ? (
                  <button type="button" onClick={cancelRequest} className="shrink-0 w-9 h-9 flex items-center justify-center rounded-[20px] border border-red-200 dark:border-red-800 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors" title="Cancel">
                    <Icon name="x" size={16} />
                  </button>
                ) : (
