    ...
    <>
      ...
      >
        <div className="mx-3 flex items-end gap-2.5">
          ...
          <div
            ref={containerRef}
            className="flex-1 overflow-hidden rounded-[26px] backdrop-blur-2xl bg-white/80 dark:bg-shark-900/70 border border-white/85 dark:border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.07),0_2px_8px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,0.90)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.40),0_2px_8px_rgba(0,0,0,0.20),inset_0_1px_0_rgba(255,255,255,0.06)]"
          >
              ...
              <div className="overflow-hidden min-h-0">
                <div className="grid grid-cols-3 gap-y-5 gap-x-3 px-5 pt-6 pb-4">
                  {moreItems.map((item) => (
                    ...
                    >
                      <div className={cn(
                        "w-[62px] h-[62px] rounded-[20px] flex items-center justify-center backdrop-blur-md border border-white/55 shadow-[inset_0_1px_0_rgba(255,255,255,0.75),0_2px_8px_rgba(0,0,0,0.10)] active:scale-95 transition-transform",
                        item.bg
                      )}>
            ...
            >
              ...
              <div
                aria-hidden="true"
                className="absolute inset-y-1 rounded-full bg-[#0071e3]/10 dark:bg-[#0071e3]/15 pointer-events-none"
                style={{
                  left:       pillLeft,
                  width:      pillWidth,
              ...
              >
                <div className="relative flex items-center justify-center">
                  <Icon
                    ...
                    className={cn(
                      ...
                      moreOpen || navActiveIdx === -1 ? "text-[#0071e3] dark:text-[#2997ff]" : "text-shark-400 dark:text-shark-500"
                    )}
                  />
                ...
                <span className={cn(
                  ...
                  moreOpen || navActiveIdx === -1
                    ? "font-bold text-[#0071e3] dark:text-[#2997ff]"
          ...
          <div className="relative shrink-0">
            ...
            <button
              ...
              className="w-[62px] h-[62px] rounded-full flex items-center justify-center touch-manipulation select-none transition-all duration-200 backdrop-blur-2xl bg-white/80 dark:bg-shark-900/70 border border-white/85 dark:border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.07),0_2px_8px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,0.90)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.40),0_2px_8px_rgba(0,0,0,0.20),inset_0_1px_0_rgba(255,255,255,0.06)]"
            >
              <Icon
                name="plus"
                size={27}
      ...
      <div className="relative flex items-center justify-center">
        <Icon
          ...
          className={cn(
            ...
            active ? "text-[#0071e3] dark:text-[#2997ff] scale-110" : "text-shark-400 dark:text-shark-500"
          )}
        />
