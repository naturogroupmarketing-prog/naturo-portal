    ...
    <section className="py-14 sm:py-20 lg:py-28 bg-shark-50/40">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Glow */}
          <div className="absolute -inset-6 bg-gradient-to-b from-action-100/40 via-action-50/20 to-transparent rounded-[20px] blur-2xl pointer-events-none" />

          <div className="relative bg-white rounded-[20px] border border-shark-200 shadow-xl shadow-shark-200/30 overflow-hidden">
            {/* App frame top bar */}
              ...
              <div className="space-y-2">
                ...
                <div className="ml-4 space-y-2">
                  {[
                    ...
                    <div key={r.name} className="flex items-center justify-between px-4 py-3 rounded-[20px] border border-shark-100 dark:border-shark-800 hover:border-shark-200 hover:shadow-sm transition-all bg-white">
          ...
          <div className="hidden sm:block absolute -right-4 lg:-right-8 top-16 z-20 animate-[floatIn_0.6s_ease-out_0.8s_both]">
            <div className="bg-white rounded-[20px] border border-shark-200 shadow-lg shadow-shark-200/40 px-3.5 py-2.5 flex items-center gap-2.5 animate-[gentleFloat_4s_ease-in-out_infinite] max-w-[200px]">
          ...
          <div className="hidden sm:block absolute -left-4 lg:-left-8 top-[55%] z-20 animate-[floatIn_0.6s_ease-out_1.1s_both]">
            <div className="bg-white rounded-[20px] border border-shark-200 shadow-lg shadow-shark-200/40 px-3.5 py-2.5 flex items-center gap-2.5 animate-[gentleFloat_5s_ease-in-out_0.5s_infinite] max-w-[200px]">
          ...
          <div className="hidden sm:block absolute -right-2 lg:-right-6 bottom-20 z-20 animate-[floatIn_0.6s_ease-out_1.4s_both]">
            <div className="bg-white rounded-[20px] border border-shark-200 shadow-lg shadow-shark-200/40 px-3.5 py-2.5 flex items-center gap-2.5 animate-[gentleFloat_4.5s_ease-in-out_1s_infinite] max-w-[190px]">
