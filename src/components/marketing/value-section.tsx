        ...
        <div className="mt-16 grid sm:grid-cols-3 gap-6">
          {[
            ...
            <ScrollReveal key={card.pain} delay={i * 150}>
              <div
                className="bg-shark-50/50 rounded-2xl p-7 border border-shark-100 dark:border-shark-800/80 hover:border-shark-200 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-pointer"
              >
