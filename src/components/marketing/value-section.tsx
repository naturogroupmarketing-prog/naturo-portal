        ...
        <ScrollReveal>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight" style={{ color: "#111827" }}>
              Spreadsheets{" "}
              <span style={{ color: "#FFD700" }}>weren&apos;t built</span>
              {" "}for this.
            </h2>
        ...
        <div className="mt-16 grid sm:grid-cols-3 gap-6">
          {[
            ...
            <ScrollReveal key={card.pain} delay={i * 150}>
              <div className="bg-gray-50 rounded-[28px] p-7 border border-gray-100 hover:border-gray-200 hover:-translate-y-1 hover:shadow-md transition-all duration-300 cursor-pointer">
                <div
                  className="w-10 h-10 rounded-[28px] flex items-center justify-center mb-5"
                  style={{ background: "rgba(0,47,160,0.08)", color: "#002FA0" }}
                >
                  {card.icon}
                </div>
                <h3 className="text-base font-semibold text-gray-900 mb-2">{card.pain}</h3>
                <p className="text-sm text-gray-400 leading-relaxed">{card.solution}</p>
              </div>
            </ScrollReveal>
          ))}
        </div>
