      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((feature, i) => (
            ...
            <div
              className="bg-white rounded-[28px] p-6 border border-shark-100 dark:border-shark-800/80 hover:border-action-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group h-full"
            >
              <div className="w-10 h-10 rounded-[28px] bg-action-50 group-hover:bg-action-500 group-hover:text-white group-hover:scale-110 group-hover:shadow-md flex items-center justify-center text-action-500 transition-all duration-300 mb-4">
                {feature.icon}
              </div>
