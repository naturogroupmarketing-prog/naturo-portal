      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {cases.map((useCase, i) => (
            ...
            <div
              className="flex items-start gap-4 p-5 rounded-[28px] border border-shark-100 dark:border-shark-800/80 bg-shark-50/30 dark:bg-shark-800/30 hover:bg-white hover:border-shark-200 hover:shadow-sm hover:-translate-y-1 transition-all duration-300 h-full"
            >
              <div className="w-10 h-10 rounded-[28px] bg-action-50 flex items-center justify-center text-action-500 shrink-0">
                {useCase.icon}
              </div>
              <div>
