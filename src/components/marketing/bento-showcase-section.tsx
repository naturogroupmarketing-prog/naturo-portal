...
function AssetListMockup() {
  ...
  return (
    <div className="w-full rounded-[20px] overflow-hidden border border-white/20 bg-white/10 backdrop-blur-sm text-white text-[11px]">
...
function AIChatMockup() {
  return (
    <div className="w-full rounded-[20px] overflow-hidden border border-white/20 bg-white/10 backdrop-blur-sm text-[11px]">
      <div className="flex items-center gap-2 px-3 py-2 border-b border-white/10 bg-white/10">
      ...
      <div className="p-3 space-y-3">
        <div className="flex justify-end">
          <div className="bg-white/20 text-white rounded-[20px] rounded-tr-sm px-3 py-1.5 max-w-[75%] text-[10px]">
        ...
        <div className="flex gap-2">
          ...
          <div className="bg-white/15 text-white rounded-[20px] rounded-tl-sm px-3 py-1.5 text-[10px] leading-relaxed">
...
function QRMockup() {
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="w-24 h-24 bg-white rounded-[20px] p-2">
    ...
    <section id="features" className="py-32 sm:py-40 px-4 sm:px-8 lg:px-16 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 auto-rows-auto">
          ...
          <div className="lg:col-span-3 rounded-[20px] overflow-hidden relative min-h-[480px] flex flex-col"
          ...
          <div className="lg:col-span-2 rounded-[20px] overflow-hidden relative min-h-[480px] flex flex-col"
          ...
          <div className="lg:col-span-2 rounded-[20px] overflow-hidden relative min-h-[420px] flex flex-col"
          ...
          <div className="lg:col-span-1 rounded-[20px] overflow-hidden relative min-h-[420px] flex flex-col"
