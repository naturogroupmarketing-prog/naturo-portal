          ...
          >
            {stats.map((stat, i) => (
              <div key={stat.label} className="relative">
                {i < stats.length - 1 && (
                  <div className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 w-px h-10 bg-gray-200" />
                )}
          ...
          {testimonials.map((t, i) => (
            <ScrollReveal key={t.name} delay={i * 150}>
              ...
              >
                ...
                <p className="text-gray-800 text-xl mb-10 leading-relaxed italic font-light relative z-10 flex-1">
                  &ldquo;{t.quote}&rdquo;
                </p>
