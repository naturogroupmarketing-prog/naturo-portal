      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            <div
              className="bg-shark-50/50 dark:bg-shark-800/50 rounded-xl p-6 border border-shark-100 dark:border-shark-800/80 hover:border-shark-200 hover:shadow-sm transition-all relative h-full"
            >
              {/* Quote mark */}
              <svg
                width="32"
